 ...
 *     description: Get all zone backups/snapshots for the authenticated user
 *     security:
 *       - BearerAuth: []
 *       - SessionAuth: []
 *     responses:
...
/**
 * @openapi
 * /api/backups/zone/{zone}:
 *   get:
 *     tags:
 *       - Backups
 *     summary: List Zone Backups
 *     description: Get all backups/snapshots for a specific zone
 *     security:
 *       - BearerAuth: []
 *       - SessionAuth: []
 *     parameters:
 ...
 *     responses:
 *       200:
 *         description: Zone backups retrieved successfully
 *         content:
 *           application/json:
 *             schema:
 *               type: object
