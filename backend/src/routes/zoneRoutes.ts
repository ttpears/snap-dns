 ...
 *     description: Fetch all DNS records for a zone. Requires a TSIG key configured for the zone.
 *     security:
 *       - BearerAuth: []
 *       - SessionAuth: []
 *     parameters:
 ...
 *         schema:
 *           type: string
 *         description: TSIG key ID to use for this zone (optional if user has only one key for the zone)
 *     responses:
 *       200:
 *         description: Zone records retrieved successfully
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *       403:
 *         description: No TSIG key configured for this zone
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/Error'
 ...
 *     description: Add a new DNS record to the zone. Requires WRITE scope and a TSIG key for the zone.
 *     security:
 *       - BearerAuth: []
 *       - SessionAuth: []
 *     parameters:
 ...
 *         schema:
 *           type: string
 *         description: TSIG key ID to use for this zone
 ...
 *               value:
 *                 record:
 *                   name: _txt.test.local
 *                   type: TXT
 *                   ttl: 300
 *                   value: "v=spf1 -all"
 *             MX_Record:
 *               summary: Add MX record
 *               value:
 *                 record:
 *                   name: test.local
 *                   type: MX
 ...
 *               $ref: '#/components/schemas/Error'
 *       403:
 *         description: Insufficient permissions or no TSIG key
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/Error'
 ...
 *     description: Delete a DNS record from the zone. Requires WRITE scope and a TSIG key for the zone.
 *     security:
 *       - BearerAuth: []
 *       - SessionAuth: []
 *     parameters:
